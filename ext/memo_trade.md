...
- les indicateurs techniques comme : RSI, moyennes mobiles, MACD

**L’analyse fondamentale**

C'est l’économie des pays derrière les monnaies.
...
Les marchés ont souvent des tendances longues.
- Acheter les actifs qui montent et vendre ceux qui baissent.
- On observe la tendance avec une relation simple entre pente et prix : pente négative → tendance baissière.

**Stratégie de suivi de tendance**  

C’est une des stratégies les plus utilisées.  
Fonctionne bien sur EUR/USD et GBP/USD    
...
**Stratégie breakout (cassure)**

Elle consiste à trader la cassure d’un niveau important.

Exemple 
- Si le marché casse une résistance forte 
- les acheteurs arrivent le prix accélère
